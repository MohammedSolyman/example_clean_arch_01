...
import 'package:flutter/material.dart';
import 'package:my_clean/features/posts/presentation_layer/widgets/posts_widgets/build_floating_btn.dart';
import 'package:my_clean/core/widgets/build_appbar.dart';
import 'package:my_clean/features/posts/presentation_layer/widgets/posts_widgets/build_posts_body.dart';
...
class PostsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(title: 'Posts'),
      body: const BuildPostsBody(),
      floatingActionButton: const BuildFloatingBtn(),
    );
  }
}
